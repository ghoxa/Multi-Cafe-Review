                ...
                <div className='row align-items-center'>
                  <div className='col-lg-2 col-4'>
                    <Link to='/home' className='brand-wrap' onClick={this.handleClickHome()}>
                      <img src='https://cdn.dribbble.com/users/4078256/screenshots/7165484/ohcaffe-dribbble_4x.png' style={{ width: 160, height: 120 }} />
                    </Link>
                  </div>
                  <div className='col-lg-6 col-sm-12'>
                    <img src='https://www.ohmyzip.com/images2017/sub/banner_ohcafevisual.jpg' style={{ width: 548, height: 120 }} />
                  </div>
