            ...
            <CardBody>
              <Form>
                <FormGroup>
                  ...
                  <Input plaintext value='Some plain text/ static value' readOnly />
                </FormGroup>
                <FormGroup>
              ...
              <Form>
                ...
                <FormGroup tag='fieldset' row>
                  ...
                  <Col sm={10}>
                    ...
                    <FormGroup check>
                      <Label check>
                        <Input type='radio' name='radio2' /> Option two can be something else and selecting it will deselect option one
                      </Label>
                    </FormGroup>
            ...
            <CardBody>
              <Form>
                <FormGroup>
                  ...
                  <Input valid />
                  <FormFeedback>
                    <a href='https://github.com/twbs/bootstrap/issues/23372'>A bug</a> fixed in (the currently unreleased) (<a href='https://github.com/twbs/bootstrap/pull/23377'>PR</a>) bootstrap{' '}
                    <a href='https://github.com/twbs/bootstrap/issues/23278'>v4 beta-2</a> shows invalid-feedback with is-valid inputs.
                  </FormFeedback>
        ...
        <Col xl={6} lg={12} md={12}>
          <Card>
            ...
            <CardBody>
              <Form inline>
                <FormGroup>
                  <Label for='exampleEmail'>Email</Label> <Input type='email' name='email' placeholder='something@idk.cool' />
                </FormGroup>{' '}
                <FormGroup>
                  <Label for='examplePassword'>Password</Label> <Input type='password' name='password' placeholder="don't tell!" />
                </FormGroup>{' '}
                <Button>Submit</Button>
              </Form>
            </CardBody>
