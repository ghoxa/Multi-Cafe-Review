        ...
        <tr style={{ height: "100px" }}>
          ...
          <td>
            <ReactStars
              edit={false}
              activeColor="#ffc107"
              value={this.state.warnReview[i].sweet}
              size={20}
              isHalf={true}
            />
          </td>
          <td>
            <ReactStars
              edit={false}
              activeColor="#ffc107"
              value={this.state.warnReview[i].bitter}
              size={20}
              isHalf={true}
            />
          </td>
          <td>
            <ReactStars
              edit={false}
              activeColor="#ffc107"
              value={this.state.warnReview[i].sour}
              size={20}
              isHalf={true}
            />
          </td>
          ...
          <td style={{ textAlign: "center" }}>
            {this.state.warnReview[i].grade}
          </td>
          <td>
            <DeleteReview
              stateRefresh={this.stateRefresh}
              reviewId={this.state.warnReview[i].reviewId}
            />
          </td>
        </tr>
      );
              ...
              <header className="border-bottom mb-4 pb-3">
                <div className="form-inline">
                  <span className="mr-md-auto">
                    {this.state.warnReview.length} Items found{" "}
                  </span>
                </div>
              </header>
