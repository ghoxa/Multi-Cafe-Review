    ...
    if (!isLoaded) {
          ...
          menulist.push(
            <Link to="/review">
              <span
                ...
                onClick={this.handleClick(menu[i]["menuId"])}
              >
      ...
      for (let i = 0; i < category.length; i++) {
        try {
          cateList.push(
            <li>
              <a onClick={this.handleClick2(category[i]["categoryId"])}>
                {category[i]["name"]}
              </a>
            </li>
          );
                  ...
                  <div className="form-inline">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a
                          class="dropdown-item"
                          onClick={this.handleClick3("good")}
                        >
                          추천순
                        </a>
                        <a
                          class="dropdown-item"
                          onClick={this.handleClick3("click")}
                        >
                          조회순
                        </a>
                      </div>
