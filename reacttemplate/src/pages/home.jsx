...
class Home extends React.Component {
  ...
  componentDidMount() {
    ...
    if (cafeId == 0 && categoryId == 0) {//아무것도 선택 안했을 때
    ...
    if (cafeId != 0 && categoryId == 0) {//카페만 선택했을 때
    ...
    if (cafeId == 0 && categoryId != 0) {//카테고리만 선택 했을 때
    ...
    if (cafeId != 0 && categoryId != 0) {// 카페, 카테고리 둘 다 선택 했을 때
